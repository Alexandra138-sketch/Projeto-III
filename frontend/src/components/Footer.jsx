...
const SOCIAL = [
  { icon: <FaLinkedinIn size={14} color="#fff" />, bg: 'linear-gradient(135deg, #9810fa 0%, #155dfc 100%)' },
  { icon: <FaTwitter size={14} color="#fff" />, bg: 'linear-gradient(135deg, #155dfc 0%, #0092b8 100%)' },
  { icon: <FaFacebookF size={14} color="#fff" />, bg: 'linear-gradient(135deg, #0092b8 0%, #9810fa 100%)' },
];
      ...
      <div className="container py-4">
        <div className="row g-4">
            ...
            <div className="d-flex gap-3">
              {SOCIAL.map((s, i) => (
                <a key={i} href="#" className="d-flex align-items-center justify-content-center rounded-circle text-decoration-none"
                  style={{ width: '32px', height: '32px', background: s.bg, flexShrink: 0 }}>
                  {s.icon}
                </a>
              ))}
            </div>
          ...
          <div className="col-6 col-lg-4">
            <h6 className="text-white fw-bold mb-3" style={{ fontSize: '16px' }}>Links Rápidos</h6>
          ...
          {/* Contacto */}
          <div className="col-6 col-lg-4">
            <h6 className="text-white fw-bold mb-3" style={{ fontSize: '16px' }}>Contacto</h6>
            <ul className="list-unstyled d-flex flex-column gap-2">
              {CONTACTO.map((c, i) => (
