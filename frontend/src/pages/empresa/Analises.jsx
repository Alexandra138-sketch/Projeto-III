...
function EmpresaAnalises() {
  ...
  useEffect(() => {
    setCarregando(true);
    Promise.allSettled([api.get('/empresa/incidentes'), api.get('/empresa/documentos')])
      .then(([incRes, docRes]) => {
        ...
        if ([incRes, docRes].every(r => r.status === 'rejected')) setErro('Não foi possível carregar os dados de análises.');
    ...
    <AdminLayout>
      ...
      <div className="card bg-primary text-white mb-4">
        <div className="card-body">
          <h4 className="fw-bold mb-1">As Minhas Análises 📊</h4>
          <p className="mb-3 opacity-75">Resumo visual dos seus incidentes e documentos.</p>
